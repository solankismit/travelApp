...
//
//     final allride = allrideFromJson(jsonString);

import 'dart:convert';

Allride allrideFromJson(String str) => Allride.fromJson(json.decode(str));

String allrideToJson(Allride data) => json.encode(data.toJson());
...
class Allride {
  ...
  factory Allride.fromJson(Map<String, dynamic> json) => Allride(
    status: json["status"],
    path: json["path"],
