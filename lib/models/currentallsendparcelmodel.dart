...
//
//     final currentallsendparcelmodel = currentallsendparcelmodelFromJson(jsonString);

import 'dart:convert';

Currentallsendparcelmodel currentallsendparcelmodelFromJson(String str) => Currentallsendparcelmodel.fromJson(json.decode(str));

String currentallsendparcelmodelToJson(Currentallsendparcelmodel data) => json.encode(data.toJson());

class Currentallsendparcelmodel {
  Currentallsendparcelmodel({
    required this.data,
  ...
  factory Currentallsendparcelmodel.fromJson(Map<String, dynamic> json) => Currentallsendparcelmodel(
...
class Datum {
  Datum({
    ...
    required this.passengerProfilePic,
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    passengerProfilePic: json["passenger_profile_pic"],
