...
import 'package:lechalo/screens/vehicle/allride.dart';
...
class RiderList extends StatefulWidget {
  ...
  // String fromloc="Ahmedabad";
  // String toloc="Jamnagar";
  // String llat="";
  // String llang="";
  // String dlat="";
  // String dlng="";
  ...
  RiderList(this.fromloc,this.toloc,this.llat,this.llang,this.dlat,this.dlng,this.distance,this.type,{Key? key}):super(key: key);
  @override
  _RiderListState createState() => _RiderListState();
}

class _RiderListState extends State<RiderList> {
  Future<bool> savedOfferidPreference(String offerid,) async {
      ...
      builder: (context, child) => Scaffold(
        ...
        body: Container(
          ...
          child: Container(
            ...
            child: FutureBuilder<Findridemodel>(future: findRide().findride(widget.fromloc, widget.toloc, regid,widget.type),
      ...
      return (snapshot.hasData) ? Padding(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              print("${server.userimage}" + "------============--------------");
              if(server.offerpriceType == "0"){
                ptype="Person";
              }else if(server.offerpriceType=="1"){
                ptype="KM" ;
              }else if(server.offerpriceType=="3"){
                ptype="Trip";
              }
              return Column(
                children: [
                  ...
                  InkWell(
                      onTap: () async {
                        ...
                        savedOfferidPreference(server.offerid).then((
                            bool commited) {
                          setState(() {
                            print("cccc");
                          });
                        });
                        savedNamePreference(regid as String,)
                            .then((bool committed) {
                          setState(() {
                            print(savedNamePreference(regid!));
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "Date: ${server.goDate.day}/${server.goDate
                                      .month}/${server.goDate.year}",
                                  style: TextStyle(
                                      color: Color(0xff020744),
                                      fontFamily: "Franklin_Gothic",
                                      fontSize: 14.sp),
      ...
      Center(child:Container(
        ...
        child: Column(
          ...
          children: [
            InkWell(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (context)=>CreatRideRequest(widget.llat,widget.llang,widget.dlat,widget.dlng,widget.fromloc,widget.toloc,widget.distance,widget.type)));
            ...
            InkWell(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (context)=>AllRide(widget.llat,widget.llang,widget.dlat,widget.dlng,widget.fromloc,widget.toloc,widget.distance,widget.type)));
              },
              child: Container(
