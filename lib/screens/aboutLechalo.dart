...
class AboutLechalo extends StatefulWidget {
  const AboutLechalo({Key? key}) : super(key: key);

  @override
  _AboutLechaloState createState() => _AboutLechaloState();
}

class _AboutLechaloState extends State<AboutLechalo> {
  @override
